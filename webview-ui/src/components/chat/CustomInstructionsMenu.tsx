      ...
      {isExpanded && (
        <div style={{ padding: "8px 0" }}>
          ...
          <div className="space-y-2">
            ...
            {!customInstructions &&
              (!fileInstructions || fileInstructions.length < 1) && (
                <p
                  style={{
                    fontSize: "12px",
                    marginTop: "5px",
                ...
                >
                  To leverage capabilities, configure instructions via the
                  settings page "Custom Instructions" field or by uploading .md
                  files [ex: place coding-style.md in the .hai/instructions
                  folder].
                </p>
              )}
          </div>
